...
def get_histogram(images, bins=256):
...
def get_maximum_likely_image(images: np.ndarray, bins=256, power=1, deterministic=False, masked_histogram=False, mask=None) -> np.ndarray:
    """_summary_
